...
Raycast::Raycast(double mouseX, double mouseY, int screenWidth, int screenHeight, glm::mat4 projection, glm::mat4 view) : mouseX(mouseX), mouseY(mouseY), screenWidth(screenWidth), screenHeight(screenHeight) {
...
bool Raycast::rayIntersectAABB(glm::vec3& min, glm::vec3& max) {
